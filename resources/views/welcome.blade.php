...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="{{ asset('img/sliders/chase-flyer.jpg') }}" alt="First slide">
            <div class="carousel-caption orange rad-5">
        ...
        <div class="carousel-item">
            <img class="d-block w-100" src="{{ asset('img/sliders/luna-couple-field.jpg') }}" alt="Second slide">
            <div class="carousel-caption blue rad-5">
                “Life is either a daring adventure or nothing.”<div class="carousel-caption-author">- Helen Keller</div>
            </div>
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="{{ asset('img/sliders/chase-flyer-sunrise.jpg') }}" alt="Third slide">
            <div class="carousel-caption orange rad-5">
        ...
        <div class="carousel-item">
            <img class="d-block w-100" src="{{ asset('img/sliders/luna-friends-desert.jpg') }}" alt="Fourth slide">
            <div class="carousel-caption blue rad-5">
